...
module Veewee
  module Command
    module Openvz
      class Define < ::Openvz::Command::Base
        def execute
          options = {}
          ...
          opts = OptionParser.new do |opts|
            ...
            opts.separator ""
            opts.separator "Usage: openvz basebox define <boxname> <template>"
          ...
          return if !argv
          raise ::Openvz::Errors::CLIInvalidUsage, :help => opts.help.chomp if argv.length < 2
          ...
          begin
            ...
            venv.ui.info "openvz basebox build '#{definition_name}'"
